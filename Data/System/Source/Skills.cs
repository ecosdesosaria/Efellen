...
namespace Server
{
	...
	public class SkillInfo
	{
		...
		{
			new SkillInfo(  0, "Alchemy",			0.0,	5.0,	5.0,	"Alquimista",	null,	0.0,	0.5,	0.5,	1.0 ),
			new SkillInfo(  1, "Anatomy",			0.0,	0.0,	0.0,	"Anatomista",	null,	0.15,	0.15,	0.7,	1.0 ),
			new SkillInfo(  2, "Druidism",			0.0,	0.0,	0.0,	"Druida",	null,	0.0,	0.0,	1.0,	1.0 ),
			new SkillInfo(  3, "Mercantile",		0.0,	0.0,	0.0,	"Mercador",	null,	0.0,	0.0,	1.0,	1.0 ),
			new SkillInfo(  4, "Arms Lore",			0.0,	0.0,	0.0,	"Especialista em Armas",	null,	0.75,	0.15,	0.1,	1.0 ),
			new SkillInfo(  5, "Parrying",			7.5,	2.5,	0.0,	"Guarda",	null,	0.75,	0.25,	0.0,	1.0 ),
			new SkillInfo(  6, "Begging",			0.0,	0.0,	0.0,	"Mendigo",	null,	0.0,	0.0,	0.0,	1.0 ),
			new SkillInfo(  7, "Blacksmithy",		10.0,	0.0,	0.0,	"Ferreiro",	null,	1.0,	0.0,	0.0,	1.0 ),
			new SkillInfo(  8, "Bowcrafting",		6.0,	16.0,	0.0,	"Arqueiro",	null,	0.6,	1.6,	0.0,	1.0 ),
			new SkillInfo(  9, "Peacemaking",		0.0,	0.0,	0.0,	"Pacificador",	null,	0.0,	0.0,	0.0,	1.0 ),
			new SkillInfo( 10, "Camping",			20.0,	15.0,	15.0,	"Explorador",	null,	2.0,	1.5,	1.5,	1.0 ),
			new SkillInfo( 11, "Carpentry",			20.0,	5.0,	0.0,	"Carpinteiro",	null,	2.0,	0.5,	0.0,	1.0 ),
			new SkillInfo( 12, "Cartography",		0.0,	7.5,	7.5,	"Cartografo",	null,	0.0,	0.75,	0.75,	1.0 ),
			new SkillInfo( 13, "Cooking",			0.0,	20.0,	30.0,	"Cozinheiro",	null,	0.0,	2.0,	3.0,	1.0 ),
			new SkillInfo( 14, "Searching",			0.0,	0.0,	0.0,	"Batedor",	null,	0.0,	0.4,	0.6,	1.0 ),
			new SkillInfo( 15, "Discordance",		0.0,	2.5,	2.5,	"Provocador",	null,	0.0,	0.25,	0.25,	1.0 ),
			new SkillInfo( 16, "Psychology",		0.0,	0.0,	0.0,	"Estudioso",	null,	0.0,	0.0,	1.0,	1.0 ),
			new SkillInfo( 17, "Healing",			6.0,	6.0,	8.0,	"Curandeiro",	null,	0.6,	0.6,	0.8,	1.0 ),
			new SkillInfo( 18, "Seafaring",			0.0,	0.0,	0.0,	"Marinheiro",	null,	0.5,	0.5,	0.0,	1.0 ),
			new SkillInfo( 19, "Forensics",			0.0,	0.0,	0.0,	"Perito Forense",	null,	0.0,	0.2,	0.8,	1.0 ),
			new SkillInfo( 20, "Herding",			16.25,	6.25,	2.5,	"Pastor",	null,	1.625,	0.625,	0.25,	1.0 ),
			new SkillInfo( 21, "Hiding",			0.0,	0.0,	0.0,	"Esgueirador",	null,	0.0,	0.8,	0.2,	1.0 ),
			new SkillInfo( 22, "Provocation",		0.0,	4.5,	0.5,	"Instigador",	null,	0.0,	0.45,	0.05,	1.0 ),
			new SkillInfo( 23, "Inscription",		0.0,	2.0,	8.0,	"Escriba",	null,	0.0,	0.2,	0.8,	1.0 ),
			new SkillInfo( 24, "Lockpicking",		0.0,	25.0,	0.0,	"Arrombador",	null,	0.0,	2.0,	0.0,	1.0 ),
			new SkillInfo( 25, "Magery",			0.0,	0.0,	15.0,	"Mago",	null,	0.0,	0.0,	1.5,	1.0 ),
			new SkillInfo( 26, "Magic Resistance",	0.0,	0.0,	0.0,	"Protetor Magico",	null,	0.25,	0.25,	0.5,	1.0 ),
			new SkillInfo( 27, "Tactics",			0.0,	0.0,	0.0,	"Tatico",	null,	0.0,	0.0,	0.0,	1.0 ),
			new SkillInfo( 28, "Snooping",			0.0,	25.0,	0.0,	"Espiao",	null,	0.0,	2.5,	0.0,	1.0 ),
			new SkillInfo( 29, "Musicianship",		0.0,	0.0,	0.0,	"Bardo",	null,	0.0,	0.8,	0.2,	1.0 ),
			new SkillInfo( 30, "Poisoning",			0.0,	4.0,	16.0,	"Envenenador",	null,	0.0,	0.4,	1.6,	1.0 ),
			new SkillInfo( 31, "Marksmanship",		2.5,	7.5,	0.0,	"Atirador",	null,	0.25,	0.75,	0.0,	1.0 ),
			new SkillInfo( 32, "Spiritualism",		0.0,	0.0,	0.0,	"Espiritualista",	null,	0.0,	0.0,	1.0,	1.0 ),
			new SkillInfo( 33, "Stealing",			0.0,	10.0,	0.0,	"Ladrao",	null,	0.0,	1.0,	0.0,	1.0 ),
			new SkillInfo( 34, "Tailoring",			3.75,	16.25,	5.0,	"Alfaiate",	null,	0.38,	1.63,	0.5,	1.0 ),
			new SkillInfo( 35, "Taming",			14.0,	2.0,	4.0,	"Domador",	null,	1.4,	0.2,	0.4,	1.0 ),
			new SkillInfo( 36, "Tasting",			0.0,	0.0,	0.0,	"Degustador",	null,	0.2,	0.0,	0.8,	1.0 ),
			new SkillInfo( 37, "Tinkering",			5.0,	2.0,	3.0,	"Funileiro",	null,	0.5,	0.2,	0.3,	1.0 ),
			new SkillInfo( 38, "Tracking",			0.0,	12.5,	12.5,	"Rastreador",	null,	0.0,	1.25,	1.25,	1.0 ),
			new SkillInfo( 39, "Veterinary",		8.0,	4.0,	8.0,	"Veterinario",	null,	0.8,	0.4,	0.8,	1.0 ),
			new SkillInfo( 40, "Swordsmanship",		7.5,	2.5,	0.0,	"Espadachim",	null,	0.75,	0.25,	0.0,	1.0 ),
			new SkillInfo( 41, "Bludgeoning",		9.0,	1.0,	0.0,	"Esmagador",	null,	0.9,	0.1,	0.0,	1.0 ),
			new SkillInfo( 42, "Fencing",			4.5,	5.5,	0.0,	"Esgrimista",	null,	0.45,	0.55,	0.0,	1.0 ),
			new SkillInfo( 43, "Fist Fighting",		9.0,	1.0,	0.0,	"Lutador",	null,	0.9,	0.1,	0.0,	1.0 ),
			new SkillInfo( 44, "Lumberjacking",		20.0,	0.0,	0.0,	"Lenhador",	null,	2.0,	0.0,	0.0,	1.0 ),
			new SkillInfo( 45, "Mining",			20.0,	0.0,	0.0,	"Minerador",	null,	2.0,	0.0,	0.0,	1.0 ),
			new SkillInfo( 46, "Meditation",		0.0,	0.0,	0.0,	"Meditador",	null,	0.0,	0.0,	0.0,	1.0 ),
			new SkillInfo( 47, "Stealth",			0.0,	0.0,	0.0,	"Furtivo",	null,	0.0,	0.0,	0.0,	1.0 ),
			new SkillInfo( 48, "Remove Trap",		0.0,	0.0,	0.0,	"Desarmador",	null,	0.0,	0.0,	0.0,	1.0 ),
			new SkillInfo( 49, "Necromancy",		0.0,	0.0,	0.0,	"Necromante",	null,	0.0,	0.0,	0.0,	1.0 ),
			new SkillInfo( 50, "Focus",				0.0,	0.0,	0.0,	"Focado",	null,	0.0,	0.0,	0.0,	1.0 ),
			new SkillInfo( 51, "Knightship",		0.0,	0.0,	0.0,	"Cavaleiro",	null,	0.0,	0.0,	0.0,	1.0 ),
			...
			new SkillInfo( 54, "Elementalism",		0.0,	0.0,	15.0,	"Elementalista",	null,	0.0,	1.0,	1.0,	1.0 ),
			new SkillInfo( 55, "Mysticism",			0.0,	0.0,	0.0,	"Mistico",	null,	0.0,	0.0,	0.0,	1.0 ),
			new SkillInfo( 56, "Imbuing",			0.0,	0.0,	0.0,	"Artifice",	null,	0.0,	0.0,	0.0,	1.0 ),
			new SkillInfo( 57, "Throwing",			0.0,	0.0,	0.0,	"Lanceiro",	null,	0.0,	0.0,	0.0,	1.0 ),
		};
