...
namespace Server.Items
{
	public class GolemManual : Item
	{
		...
		public static bool ProcessGolemBook( Mobile m, Mobile tinker, Item dropped )
		{
			...
			{
				tinker.SayTo(m, "Não posso construir isso. Você ainda está com materiais faltando!");
		...
		public class GolemManualGump : Gump
		{
			...
			public GolemManualGump( Mobile from, GolemManual gBook ): base( 100, 100 )
			{
				...
				string sText = "Este tomo raro contém o conhecimento para construir um golem de metal. Em suas páginas você verá o que precisa obter para construí-lo. Você precisará de lingotes de acordo com a construção de metal do golem indicada aqui. Também precisará de conjuntos de mecanismos, cristais de poder, gemas arcanas, engrenagens, óleos de tecnomante e ouro para a taxa do funileiro. O funileiro que pode construir este golem está na localização mostrada no final da primeira página. Se você tiver alguma habilidade em funilaria, eles podem reembolsar parte do ouro pela ajuda que você pode fornecer na construção. Existem dois tipos de golems que podem ser construídos. Um é um golem combatente, que lutará ao seu lado. O outro é um golem trabalhador, que carregará o que você não quiser carregar. Golems trabalhadores não podem ser feridos e são ignorados por criaturas hostis. Além disso, eles também não podem atacar nada. Eles requerem 5 slots de seguidor para acompanhá-lo. Você precisará de um golem combatente se quiser que eles enfrentem outros em combate. Ao contrário dos golems trabalhadores, os golems combatentes só precisam de 3 slots de seguidor para acompanhá-lo. Quanto melhor a construção de metal, mais forte o golem. Você só precisa obter molas se estiver construindo um golem combatente. Ao encontrar materiais, simplesmente arraste e solte-os sobre este livro para adicionar aos materiais. A primeira página rastreará o que você obteve até agora. Quando todos os itens forem adquiridos (lembre-se, as molas são opcionais), entregue este tomo a um funileiro e eles construirão seu golem. O golem construído será apenas seu, e terá uma quantidade limitada de cargas. Uma carga é usada sempre que você traz o golem para viajar com você. Você terá que obter mais cristais de poder para adicionar mais cargas, onde cada cristal de poder adicionará 5 cargas extras a um golem trabalhador e 1 carga extra a um golem combatente. Um golem só pode conter 100 cargas por vez. Golems são controlados como bestas domadas ou criaturas invocadas. Eles podem receber ordens para seguir, ficar ou parar. O golem trabalhador terá uma mochila que você pode acessar. Você também pode dispensar o golem, onde o item constructo reaparecerá em sua mochila. Se você dispensar um golem trabalhador, qualquer coisa carregada será deixada no chão. Eles são autômatos, então não precisam ser alimentados, além dos cristais de poder já mencionados. Lembre-se, eles não são transferíveis uma vez construídos. Aquele que entregar o livro ao funileiro será o dono do golem que for construído.";
