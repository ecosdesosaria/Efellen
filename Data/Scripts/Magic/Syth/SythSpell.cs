...
namespace Server.Spells.Syth
{
	public abstract class SythSpell : Spell
	{
		...
		public static string SpellInfo( int spellID, int slice )
		{
			...
			else if ( spellID == 274 ){ name = "Speed"; icon="1043"; crystal = "80"; skill = "50"; mana = "20"; mantra = "Qyasik Tukata"; map = "Sosaria"; dungeon = "Library of Bal Tsareth"; world = "Land of Sosaria"; syth = "Lord Monduiz Dephaar"; scroll = "SythDatacron05"; 
