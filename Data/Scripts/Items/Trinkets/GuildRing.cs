		...
		public GuildRing( Mobile from, int guild )
		{
			...
			switch( guild )
			{
				...
				case 2: RingGuild = "WarriorsGuild"; RingName = "Member of the Warriors Guild"; 
					SkillBonuses.SetValues(0, SkillName.Tactics, 30); break;
				case 3: RingGuild = "ThievesGuild"; RingName = "Member of the Thieves Guild"; 
					SkillBonuses.SetValues(0, SkillName.Lockpicking, 10); 
					SkillBonuses.SetValues(1, SkillName.Snooping, 10); 
					SkillBonuses.SetValues(2, SkillName.Stealing, 10);break;
				case 4: RingGuild = "RangersGuild"; RingName = "Member of the Rangers Guild"; 
					SkillBonuses.SetValues(0, SkillName.Camping, 15);
					SkillBonuses.SetValues(1, SkillName.Tracking, 15); break;
				...
				case 7: RingGuild = "MerchantsGuild"; RingName = "Member of the Merchants Guild"; 
					...
					SkillBonuses.SetValues(2, SkillName.Tasting, 10); break;
				...
				case 11: RingGuild = "BardsGuild"; RingName = "Member of the Bards Guild"; 
					SkillBonuses.SetValues(0, SkillName.Musicianship, 30);break;
				case 12: RingGuild = "BlacksmithsGuild"; RingName = "Member of the Blacksmiths Guild"; 
					SkillBonuses.SetValues(0, SkillName.Blacksmith, 15); 
					SkillBonuses.SetValues(1, SkillName.ArmsLore, 15); break;
				...
				case 15: RingGuild = "DruidsGuild"; RingName = "Member of the Druids Guild";
					...
					SkillBonuses.SetValues(2, SkillName.Veterinary, 10); break;
				case 16: RingGuild = "ArchersGuild"; RingName = "Member of the Archers Guild";
					SkillBonuses.SetValues(0, SkillName.Marksmanship, 15); 
					SkillBonuses.SetValues(1, SkillName.Bowcraft, 15);break;
				case 17: RingGuild = "CarpentersGuild"; RingName = "Member of the Carpenters Guild";
					SkillBonuses.SetValues(0, SkillName.Carpentry, 15); 
					SkillBonuses.SetValues(1, SkillName.Lumberjacking, 15); break;
				...
				case 19: RingGuild = "LibrariansGuild"; RingName = "Member of the Librarians Guild";
					SkillBonuses.SetValues(0, SkillName.Inscribe, 30); break;
				case 20: RingGuild = "CulinariansGuild"; RingName = "Member of the Culinary Guild";
					SkillBonuses.SetValues(0, SkillName.Cooking, 15); 
					SkillBonuses.SetValues(1, SkillName.Tasting, 15); break;
				case 21: RingGuild = "AssassinsGuild"; RingName = "Member of the Assassins Guild";
					...
					SkillBonuses.SetValues(2, SkillName.Stealth, 10); break;
