...
namespace Server.Items
{
	public class Artifact_EdgeOfDawn : GiftNoDachi
	{
		...
		public Artifact_EdgeOfDawn()
		{
			...
			ArtifactLevel = 2;
			Server.Misc.Arty.ArtySetup(this, "O dever do amanhecer é abrigar todos na revelação.");
	...
	out int direct)
		...
		public override bool OnEquip(Mobile from)
		{
			if (from.Fame < 10000)
			{
				from.SendMessage("A Beira do Amanhecer te julga indigno.");
				return false;
			}
		...
		public override void OnHit(Mobile attacker, Mobile defender, double damageBonus)
		{
			...
			attacker.SendMessage(0x455, "Beira do Amanhecer traz a luz!");
