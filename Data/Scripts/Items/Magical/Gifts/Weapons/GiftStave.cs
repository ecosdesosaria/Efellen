...
namespace Server.Items
{
	...
	public class BaseGiftStave : BaseGiftRanged
	{
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			{
				from.SendMessage( "Quais gemas você quer transmorfar?" );
				t = new GemTarget();
				from.Target = t;
			}
		}
		...
		private class GemTarget : Target
		{
			...
			protected override void OnTarget( Mobile from, object targeted )
			{
				...
				if ( iGem is StarSapphire || iGem is Emerald || iGem is Sapphire || iGem is Ruby || iGem is Citrine || iGem is Amethyst || iGem is Tourmaline || iGem is Amber || iGem is Diamond )
				{
					...
					{
						from.SendMessage( "Você só pode transformar gemas em sua mochila." );
					}
					else
					{
						int amount = 4;
						...
						from.SendMessage( "Você transmorfa as gemas em mage eyes." );
						iGem.Delete();
					}
				}
				else
