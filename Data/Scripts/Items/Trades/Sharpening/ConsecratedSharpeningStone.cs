...
namespace Server.Items
{
	public class ConsecratedSharpeningStone : Item
	{
        ...
        public override void AddNameProperties(ObjectPropertyList list)
		{
			...
			list.Add( 1070722, "Pode Aumentar O Dano De Uma Arma De Espada");
			list.Add( 1049644, "Irá Abençoar A Arma"); // PARENTHESIS
        }
			...
			if ( o is Item )
			{
				...
				else if (o is BaseSword && ((BaseSword)o).IsChildOf(from.Backpack))
				{
					...
					if (i_DI >= 70)
					{
						...
						from.SendMessage(32, "Você precisa de pelo menos 100.0 em Ferraria e 80.0 em Cavalaria para afiar armas com esta pedra");
