...
namespace Server.Items
{
	public class reagents_magic_jar1 : Item
	{
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			else
			{
				...
				from.PrivateOverheadMessage(MessageType.Regular, 0x14C, false, "Você despeja o conteúdo em sua mochila", from.NetState);
				this.Delete();
			}
		}
        ...
        public override void AddNameProperties(ObjectPropertyList list)
		{
			...
			list.Add( 1070722, "Este Jarro Contém 50 de Cada Reagente de Mago");
			list.Add( 1049644, "Clique Duas Vezes Para Esvaziar Em Sua Mochila");
        }
	...
	public class reagents_magic_jar2 : Item
	{
        ...
        public override void AddNameProperties(ObjectPropertyList list)
		{
			...
			list.Add( 1070722, "Este Jarro Contém 50 de Cada Reagente de Necromante");
			list.Add( 1049644, "Clique Duas Vezes Para Esvaziar Em Sua Mochila");
        }
	...
	public class reagents_magic_jar3 : Item
	{
        ...
        public override void AddNameProperties(ObjectPropertyList list)
		{
			...
			list.Add( 1070722, "Este Jarro Contém 50 de Cada Reagente Alquímico");
			list.Add( 1049644, "Clique Duas Vezes Para Esvaziar Em Sua Mochila");
        }
