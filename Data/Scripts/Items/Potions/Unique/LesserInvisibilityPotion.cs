...
namespace Server.Items
{
	...
	{
		public override string DefaultDescription{ get{ return "Beber esta poção o tornará invisível e também lhe concederá maestria em furtividade e discrição. Estas poções não permitem que alguém se mova furtivamente com armaduras pesadas. O efeito da poção dura 1 minuto."; } }
