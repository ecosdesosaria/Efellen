...
namespace Server.Items
{
	public abstract class BaseConflagrationPotion : BasePotion
	{
		...
		public override string DefaultDescription{ get{ return "Estas poções criarão um campo de fogo, onde atravessá-lo causará entre " + MinDamage + " e " + MaxDamage + " de dano. O campo dura cerca de 30 segundos."; } }
