...
namespace Server.Misc
{
    class ChangeLog
    {
		...
		+ "<br>"
        + "* NPCS:<br>"
		+"		- NPCS have a lot more to say now. About 400 new things to say.<br>"
		+ "<br>"
		+ "* Locations:<br>"
		+ "		- Added a new mini dungeon called the Myconid caves close to the eastern coast of Sosaria.<br>"
		+"		- All newbie dungeons now have one extra room with more challenging monsters. They also had their spawn pool rebuilt to be more consize.<br>"
