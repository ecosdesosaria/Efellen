...
namespace Server.Misc
{
    class ChangeLog
    {
        ...
        + "Ashardalon Awakes - X of Y of (hopefully) 2026<br>"
		...
		+"  	receive a new talisman item called 'Heart of the Wilds', which will immediately allow the character to shapeshift into a wolf.<BR>"
