			...
			get
			{
				if ( m_OrcSpeech == null )
				{
					...
					m_OrcSpeech.Syllables = new string[]
						{
							"Gruumsh", "khar", "nuugash-bek", "ju", "kraavak",
							"ulg", "gug", "gub", "gur", "rak",
							"gub", "log", "ru", "stu", "glu",
							"ug", "ud", "og", "tur-in", "tuu", "shaa",
							"shyruuk", "duf", "vaakarn", "nog", "dun", "bog",
							"suu", "gh", "gruuthor", "gho", "nug", "ig",
							"seh-vaak", "ihg", "kreb", "duh", "bug", "dug",
							"dru", "urd", "gurt", "grut", "grunt",
							"snarf", "urgle", "bah-hak", "glu", "glug",
							"foo", "bar", "baz", "ghat", "ab", "ad",
							"gugh", "guk", "ag", "alm", "thu", "log",
							"bilge", "augh", "gha", "gig", "goth",
							"zug", "pig", "auh", "gan", "azh", "bag",
							"hig", "oth", "dagh", "gulg", "ugh", "nurthaag",
							"bid", "gug", "thrull", "rug", "hat", "brui",
							"gagh", "buad", "buil", "buim", "bum",
							"hug", "hug", "buo", "ma", "buor", "ghed",
							"buu", "phaag", "guk", "clog", "thurg", "car",
							"cro", "thu", "othar", "cuk", "gil", "cur", "dak",
							"dar", "deak", "der", "dil", "dit", "at", "ag",
							"dor", "gar", "dre", "ûr", "dri", "gka", "rim",
							"eag", "egg", "vah-muut", "baj=hakh", "krebl-baa", "lat", "eichel",
							"ek", "ep", "Draakh", "it", "ut", "ewk", "ba", "dagh",
							"faugh", "foz", "fog", "fid", "fruk", "gag", "fub",
							"fud", "fur", "tuu", "fup", "hagh", "gaa", "kt",
							...
							"om", "dud", "oo", "pa", "hrak", "vah", "quad", "quil",
							"ghig", "rur", "sag", "sah", "mauthaug"
						};
				}
