...
namespace Server.Custom.DefenderOfTheRealm.Vow.VowOfTheScourge
{
    public class VowOfTheScourge : Item
    {
        ...
        public override string DefaultDescription{ get{ return "O Juramento representa o compromisso de abater inimigos temíveis que habitam em masmorras. Quando concluído, leve-o até quem o concedeu a você. Diga 'rewards' a essa pessoa para ver quais presentes podem ser concedidos a você ao completá-los."; } }
        ...
        public override void GetProperties(ObjectPropertyList list)
        {
            ...
            list.Add("Um juramento de adquirir {0} troféus", m_Required);
        ...
        public void AddTrophy(Mobile from)
        {
            ...
            if (m_Current >= m_Required)
            {
                from.SendMessage("Seu juramento do Flagelo está completo!");
            }
        }
        ...
        public override bool OnDroppedToMobile(Mobile from, Mobile target)
        {
            ...
            {
                from.SendMessage("Você só pode completar seu Juramento com um Flagelo do Reino.");
                return false;
            }
            ...
            from.SendMessage("Você completou seu Juramento do Flagelo e recebeu uma bolsa contendo {0} Marcas do Flagelo e recompensas adicionais!", m_Reward);
