...
{ 
	...
	public class PossessedScholar : BaseSpellCaster
	{ 
		[Constructable] 
		...
		public override void OnAfterSpawn()
		{
			...
			this.MobileMagics(Utility.Random(3,5), SpellType.Wizard | SpellType.Sorcerer, 0x0213);
			base.OnAfterSpawn();
		}
		...
		public override void Deserialize( GenericReader reader )
		{
			...
			if(version >= 2)
			{
				this.MobileMagics(Utility.Random(3,5), SpellType.Wizard, 0x0213);
			}
		}
	}
}