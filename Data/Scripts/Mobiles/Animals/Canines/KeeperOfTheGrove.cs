...
{ 
	...
	public class KeeperOfTheGrove : BaseCreature 
	{
		...
		[Constructable] 
		public KeeperOfTheGrove() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 ) 
		{
		...
		public KeeperOfTheGrove( Serial serial ) : base( serial ) 
		{ 
		} 
