    ...
    public class ThiefGuildmaster : BaseGuildmaster
    {
        ...
        public override void OnSpeech(SpeechEventArgs e)
        {
            ...
            if (e.Mobile.InRange(this, 4))
            {
                ...
                {
                    MaybeShowShadowbrokerRewardsGump(from as PlayerMobile);
                }
                else
                {
                    base.OnSpeech(e);
        ...
        public void MaybeShowShadowbrokerRewardsGump(PlayerMobile from)
        {
        ...
        private class RewardsEntry : ContextMenuEntry
        {
            ...
            public RewardsEntry(ThiefGuildmaster ThiefGuildmaster, Mobile from) : base(6093, 3)
            {
                m_ThiefGuildmaster = ThiefGuildmaster;
                m_From = from;
                Enabled = m_ThiefGuildmaster.CheckVendorAccess(from);
            ...
            public override void OnClick()
            {
                m_ThiefGuildmaster.MaybeShowShadowbrokerRewardsGump(m_From as PlayerMobile);
            }
        }
